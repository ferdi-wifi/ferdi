...
urlpatterns = [
    ...
    path('delete-pelanggan/<str:pk>', views.deletepelanggan_admin, name='deletepelanggan_admin'),
     ...
     path('teknisi-admin/', views.teknisi_admin, name='teknisi_admin'),
     path('form-teknisi/', views.formteknisi_admin, name='formteknisi_admin'),
    path('edit-teknisi/<str:pk>', views.editteknisi_admin, name='editteknisi_admin'),
    path('delete-teknisi/<str:pk>', views.deleteteknisi_admin, name='deleteteknisi_admin'),
